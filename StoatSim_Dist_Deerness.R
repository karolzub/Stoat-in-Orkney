...
### There is no by-catch as there are only locations of traps (in reality there are two traps in every location)
...
stoat.dist<-function(init.density, n.trap, trap.dist, n.day, g0, sigma)
...
### Packages required.
        ...
        for (i in 1:tot.stoat){
                ...
                tot.trap<-(1-prod((1-p.capt)^n.day))                     ### Probability of capture in any given trap after the total number of nights
