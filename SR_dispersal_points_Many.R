...
source("C:/Orkney/Model/SR_dispersal_points.R")
...
#resistanceSR <- resistanceFromShape("C:/Orkney/Model/SR_habitats.shp", res = 10, field = "Habitat", mapvalues = c("coast" = 0.1, "grassland" = 0.8, "meadow" = 0.8, "heatland" = 0.8,"marine" = 0.1, "road" = 0.8, "town" = 0.9,"water" = 1.00, "wood" = 0.8 ), background = 1.00, margin = 1000)
...
CRW<-round(qunif(lhs1[,1], 0.95, 0.99), digits=4)           ### Probability of by-catch per trap day

step<-round(qunif(lhs1[,2], 100, 300), digits=2)           ### Probability of by-catch per trap day

horizon<-round(qunif(lhs1[,3], 100, 500), digits=2)           ### Probability of by-catch per trap day

time<-round(qunif(lhs1[,4], 1000, 3000), digits=2)           ### Probability of by-catch per trap day

init.density<-round(qunif(lhs1[,5], 0.005, 0.01), digits=4)
