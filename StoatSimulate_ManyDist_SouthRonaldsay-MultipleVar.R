...
source("C:/Orkney/Model/StoatSim_Dist_SouthRonaldsay.R")
...
stoat.sim<-matrix(0, nrow=2, ncol=n.sim) #### The first column is the %caught, the second are the remaining stoats
