...
#nnet.mean<-cv4abc(param=t(prior3), sumstat=t(pred3), nval=100, tols=c(0.1, 0.5, 1), statistic = "median", method="neuralnet")
...
write.table(post.pred, "d:/CONTAIN/Stoats RSPB/Modelling results/Inference-ModelSETrapPerTrap.csv", sep=",")
