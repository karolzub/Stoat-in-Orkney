...
source("C:/Orkney/Frontiers/Model2_1.R")

stoat.hr<-cmpfun(stoat.dist)

access <- readOGR("C:/Orkney/Model/Access_summer_2020.shp")
...
n.trap<-round(qunif(lhs1[,3], 1000, 7500), digits=0)           ### Total number of traps
...
sens.mod<-gbm.step(sens.data, gbm.x=c(2:8), gbm.y=1, tree.complexity=3, learning.rate=0.001, bag.fraction=0.7, step.size=100, max.trees=10000,  n.folds=10, family="gaussian")
