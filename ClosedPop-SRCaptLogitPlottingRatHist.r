...
### Plotting the posterior estimate of the rat abundance
set.seed(2012)
...
rem.conf<-configureMCMC(Rmodel,  monitors=list('n.rat'), thin=1)
...
hist(c(unlist(out.post)), ylab="Frequency", xlab="Rat population size", main="Estimated rat population size")
