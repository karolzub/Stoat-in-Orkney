...
### Plotting the posterior estimate of the probability of capture of rats as a function of the trapping effort
set.seed(2012)
...
rem.conf<-configureMCMC(Rmodel,  monitors=list('p.rat'), thin=10)
...
plot(av.det~log10(eff.stoat), type="l", lwd=4, ylim=c(0, 0.1), main="Rat probability of capture", ylab="Probability of capture",
