...
source("C:/Orkney/Model/StoatSim_Dist_Deerness.R")
...
n.trap<-round(qunif(lhs1[,3], 10, 200), digits=0)           ### Total number of traps
...
sens.data <- data.frame(prop.stoat=stoat.sim[1, ], n.day = n.day, init.density = init.density, n.trap = n.trap, trap.dist= trap.dist, g0=g0, sigma = sigma)
