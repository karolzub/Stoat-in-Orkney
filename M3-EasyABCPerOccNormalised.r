...
abc.pf<-ABC_sequential(method="Lenormand", model=se.stoat, prior=prior.list, nb_simul=n.its, summary_stat_target=norm.stat,
...
write.table(abc.pf$stats, "d:/CONTAIN/Stoats RSPB/Modelling results/Inference-ABCSMC.csv", sep=",")

write.table(abc.pf$param, "d:/CONTAIN/Stoats RSPB/Modelling results/ParamEstimates-ABCSMC.csv", sep=",")
